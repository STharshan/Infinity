...
const services = [
  {
    ...
    desc: `Transparent film that shields your car’s paint from scratches, chips, and minor damage.`,
    image: "/carpaint.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[60%] rounded-2xl mt-15 mx-auto h-40 object-cover"
                    onError={(e) => {
